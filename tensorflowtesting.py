...
def neural_network_model(data):
    ...
    hidden_m_layer={"weight": tf.Variable(tf.random_normal([n_nodes_hl3, n_nodes_hl3])),
                   "biases": tf.Variable(tf.random_normal([n_nodes_hl3]))}
    ...
    #l4= tf.add(tf.matmul(l3, hidden_m_layer["weight"]), hidden_m_layer["biases"])
    #l4=tf.nn.relu(l4)
    #l4= tf.add(tf.matmul(l4, hidden_m_layer["weight"]), hidden_m_layer["biases"])
    #l4=tf.nn.relu(l4)
